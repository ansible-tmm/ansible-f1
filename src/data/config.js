...
export const DRIVERS = {
  ...
  justin: {
    ...
    origin: "Durham, North Carolina",
    bio: "Justin Braun is the kind of guy who walks into a room and immediately needs everyone to know he's there. Not in a bad way — in a 'hold on, let me tell you about my evening' way. Prefers Club Haunted House even more than Club Aqua, and will not shut up about it. His friend built the deck at Club Haunted House — it's a great deck, beautiful deck, completely over-engineered, the guy spent three weekends on it. Justin used to be a real piece of work. Used to do Sloppy Steaks at Truffoni's — big rare steak, glass of water, slicked-back hair. You wouldn't have liked him. He's changed. He's not that guy anymore. Gave a keynote at an Ansible conference that was supposed to be fifteen minutes and went forty-five because he kept circling back to how the tables in the venue were the exact right shape. Loves public speaking — lives for it, feeds off it, will absolutely volunteer to present your slides if you even hesitate. Once gave a lightning talk where he just described all his shirts for seven minutes. The audience gave him a standing ovation. Built an Ansible playbook that automated his entire morning routine including brewing coffee, but the playbook had a bug that brewed seventeen cups, and instead of fixing it he just drank all seventeen. Doesn't think you should hold back on gift receipts — it's not rude, it's practical. Has very strong opinions about whether or not bones are money. They are not. Will fight you on this. Was nominated for Baby of the Year three years running at his local community center, even though he is a grown man and the nomination is supposed to be for actual babies. Won twice. Has a dedicated Coffin Flop folder on his laptop that he will show you at lunch whether you want to see it or not. They didn't do anything — they're just dead bodies falling out of coffins. Once rear-ended a hot dog car on I-40 and blamed the driver for not knowing how to steer a hot dog. Told the officer at the scene he didn't even want to be around anymore — the officer let him go. Owns a black and gold F1 car because he thinks it looks like a fancy pen, and he has always wanted to be the kind of person who carries a fancy pen. They call him 'The Presentation.' The meeting could have been an email, but Justin made sure it wasn't.",
  },
};
